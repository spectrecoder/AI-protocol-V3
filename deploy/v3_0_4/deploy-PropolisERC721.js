// deploy: npx hardhat deploy --network goerli --tags PropolisERC721
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("PropolisERC721", {
...
module.exports.tags = ["PropolisERC721", "v3_0_4", "deploy"];
