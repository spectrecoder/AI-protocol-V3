// deploy: npx hardhat deploy --network goerli --tags PropolisERC20
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("PropolisERC20", {
...
module.exports.tags = ["PropolisERC20", "v3_0_4", "deploy"];
