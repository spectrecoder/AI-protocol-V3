// run: npx hardhat deploy --network goerli --tags setup-PropolisERC20
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// setup PropolisERC20
	{
		...
		const deployment = await deployments.get("PropolisERC20");
		...
		if(!features.eq(requested_features)) {
			...
			console.log("PropolisERC20.updateFeatures(%o): %o", requested_features.toString(2), receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["setup-PropolisERC20", "v3_0_4", "setup"];
module.exports.dependencies = ["PropolisERC20"];
