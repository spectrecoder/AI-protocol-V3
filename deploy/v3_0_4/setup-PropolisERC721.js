// run: npx hardhat deploy --network goerli --tags setup-PropolisERC721
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// setup PropolisERC20
	{
		...
		const deployment = await deployments.get("PropolisERC721");
		...
		if(!features.eq(requested_features)) {
			...
			console.log("PropolisERC721.updateFeatures(%o): %o", requested_features.toString(2), receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["setup-PropolisERC721", "v3_0_4", "setup"];
module.exports.dependencies = ["PropolisERC721"];
