// deploy: npx hardhat deploy --network base_goerli --tags SubjectNFT
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// WhitelabelNFT (SubjectNFT) a.k.a. DPT
	{
		// deploy if required
		await deployments.deploy("SubjectNFT", {
			...
			args: ["Decentralized Pre-Trained Transformer", "DPT"],
...
module.exports.tags = ["SubjectNFT", "v3_0", "deploy"];
